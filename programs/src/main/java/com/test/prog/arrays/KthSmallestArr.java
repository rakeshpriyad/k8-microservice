package com.test.prog.arrays;// Java code for kth smallest element in an array
...
public class KthSmallestArr {
	...
	public static int kthSmallestSimple(Integer[] arr,
								  int k)
	{
	...
	{ 
		...
		System.out.print("K'th smallest element is " + kthSmallestSimple(arr,k));
	} 
} 
