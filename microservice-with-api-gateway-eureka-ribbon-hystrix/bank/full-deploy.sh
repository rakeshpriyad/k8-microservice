...
BANK_DIR=${BASE_DIR}/k8-microservice/microservice-with-api-gateway-eureka-ribbon-hystrix/bank
...
kubectl delete deployments load-balance-service 2>/dev/null || echo "No more load-balance-service deployment to remove."
